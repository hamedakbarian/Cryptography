...
public class Main {
    ...
    private static void VerifyDSAMessage() {
        ...
        try {
            ...
            PublicKey publicKey = getPublicKey("D://KeyStore2/key/my_pkcs12.p12");
    ...
    private static void SignDSAMessage() {
        ...
        try {
            ...
            PrivateKey privateKey = getPrivateKey("D://KeyStore2/key/my_pkcs12.p12");
    ...
    public static PrivateKey getPrivateKey(String filename)
        ...
        //FileInputStream fis = new FileInputStream("D://KeyStore2/key/my_pkcs12.p12");
